...
enum Events
{
    ...
    EVENT_PHASE_3_1                    = 20,    //диалог?
    EVENT_PHASE_3_2                    = 21,    //диалог?
    EVENT_PHASE_3_3                    = 22,    //диалог?
    EVENT_PHASE_3_4                    = 23,    //диалог?
...
enum Adds
{
    ...
    NPC_ASCENDANT_COUNCIL_TARGET_STALKER    = 44553,    //непо?тн? откуда эт?
...
const Position councilPos[4] = 
{
    ...
    {-1054.04f, -600.60f, 835.03f, 0.42f},    //огни?
    {-1057.89f, -653.51f, 877.70f, 0.79f},    //арио?
    {-1057.93f, -533.38f, 877.68f, 5.47f},    //террастр?
};

const Position groundPos[7] = 
{
    {-1038.45f, -590.60f, 831.98f, 6.04f},    //на 2?фазе сюда прыгае?арио?
    {-1034.61f, -571.70f, 831.90f, 6.04f},    //на 2?фазе сюда прыгае?террастр?
    {-1008.42f, -571.32f, 831.90f, 4.71f},    //на 3?фазе исходн? точк?акварион?
    {-995.92f, -582.68f, 831.90f, 3.18f},    //на 3?фазе исходн? точк?огниса
    {-1008.75f, -594.82f, 831.90f, 1.52f},    //на 3?фазе исходн? точк?ариона
    {-1020.88f, -582.67f, 831.90f, 0.0f},    //на 3?фазе исходн? точк?террастр?
    {-1008.58f, -582.97f, 831.90f, 6.23f},    //на 3?фазе точк?спавна монстросит?
};
